...
- (nullable NSNumber *)createPlatformViewPlayerWithOptions:(nullable FVPCreationOptions *)params error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable FVPTexturePlayerIds *)createTexturePlayerWithOptions:(nullable FVPCreationOptions *)creationOptions error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)setDataSource:(FVPCreationOptions *)options error:(FlutterError *_Nullable *_Nonnull)error;
