...
public class TextureExoPlayerEventListenerTest {
  ...
  public void
    ...
    verify(mockCallbacks).onInitialized(new VideoPlayerCallbacks.PlaybackInfo(800, 400, 10L, 0));
  }
  ...
  public void
    ...
    eventListener.onPlaybackStateChanged(Player.STATE_READY);
    verify(mockCallbacks).onInitialized(new VideoPlayerCallbacks.PlaybackInfo(800, 400, 10L, rotationCorrection));
  }
  ...
  public void
    ...
    eventListener.onPlaybackStateChanged(Player.STATE_READY);
    verify(mockCallbacks).onInitialized(new VideoPlayerCallbacks.PlaybackInfo(800, 400, 10L, 90));
  }
  ...
  public void
    ...
    eventListener.onPlaybackStateChanged(Player.STATE_READY);
    verify(mockCallbacks).onInitialized(new VideoPlayerCallbacks.PlaybackInfo(800, 400, 10L, 270));
  }
}
