...
public class Messages {
  ...
  public interface AndroidVideoPlayerApi {
    ...
    @NonNull 
    TextureMessage create(@Nullable CreateMessage msg);

    void dispose(@NonNull TextureMessage msg);

    void setDataSource(@NonNull TextureMessage textureMsg, @NonNull CreateMessage msg);
    ...
    void stop(@NonNull TextureMessage msg);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setDataSource" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                TextureMessage textureMsgArg = (TextureMessage) args.get(0);
                CreateMessage msgArg = (CreateMessage) args.get(1);
                try {
                  api.setDataSource(textureMsgArg, msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.stop" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
